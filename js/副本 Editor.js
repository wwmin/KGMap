require(["dojo/dom","dojo/on","esri/Color","dojo/parser",  "esri/config","esri/sniff","dojo/_base/array", "dijit/registry", "esri/tasks/QueryTask", "dojo/query",
    "esri/map","esri/geometry/Extent","esri/SpatialReference", "esri/InfoTemplate","esri/SnappingManager","esri/dijit/Measurement","esri/renderers/SimpleRenderer", "esri/symbols/PictureMarkerSymbol","esri/symbols/SimpleLineSymbol",
    "esri/symbols/SimpleFillSymbol", "esri/dijit/editing/Editor", "esri/dijit/Print", "esri/dijit/AttributeInspector", "esri/layers/ArcGISTiledMapServiceLayer",
    "esri/layers/FeatureLayer","esri/tasks/GeometryService","esri/graphic", "esri/toolbars/draw","esri/units",
    ...
    "esri/dijit/Scalebar", "dojo/data/ItemFileReadStore","dijit/TitlePane","dojox/grid/DataGrid","dijit/form/Button",
    "dijit/layout/BorderContainer", "dijit/layout/ContentPane", "dojo/domReady!"],
    function (dom,on,Color,parser,esriConfig,has,array,registry,QueryTask,Query,
              Map,Extent,SpatialReference, InfoTemplate, SnappingManager,Measurement,SimpleRenderer,PictureMarkerSymbol,SimpleLineSymbol,
              SimpleFillSymbol,Editor,Print, AttributeInspector, ArcGISTiledMapServiceLayer,
              FeatureLayer,GeometryService,Graphic,Draw,Units,CheckBox,keys,ToolbarSeparator,HomeButton,LocateButton,OverviewMap,Scalebar,ItemFileReadStore) {
        //parser.parse();
