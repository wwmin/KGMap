require(["dojo/parser", "dijit/registry", 'dojo/on', "esri/map", "esri/geometry/Extent", "esri/SpatialReference", "esri/InfoTemplate", "esri/layers/ArcGISTiledMapServiceLayer", "esri/graphic", "esri/toolbars/draw",
    ...
    function (parser, registry, on, Map, Extent, SpatialReference, InfoTemplate, ArcGISTiledMapServiceLayer, Graphic, Draw,
        ...
        var streetMap = new ArcGISTiledMapServiceLayer("http://60.29.110.104:6080/arcgis/rest/services/外业点位图map20151207/MapServer");
        ...
        function setGridHeader() {
            var layout = [
                 ...
                 { field: 'TYPE', name: '类型', width: "50px", headerStyles: "text-align:center;" },
                 { field: 'CID', name: '编码', width: "50px", headerStyles: "text-align:center;" },
                 { field: 'NUM', name: '数量', width: "50px", headerStyles: "text-align:center;" },
                 { field: 'MONTH', name: '月份', width: "50px", headerStyles: "text-align:center;" }
            ];
        ...
        function drawTable(features) {
            ...
            var data = {
                identifier: "OBJECTID",  //This field needs to have unique values    为什么不能用ObjectID
                label: "OBJECTID", //Name field for display. Not pertinent to a grid but may be used elsewhere.
                items: items
            };
            var store = new ItemFileReadStore({ data: data });
            gridWidget.setStore(store);
            gridWidget.setQuery({ OBJECTID: '*' });  //grid数据排序
        }
